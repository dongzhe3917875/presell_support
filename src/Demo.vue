<template>
	<div class='wrapper'>
  	...
  	<simple-product url='/dongzhe/get_price'></simple-product>
  	<div class='info'>
  		<price></price>
  		<spinner url='/dongzhe/get_price'></spinner>
  	</div>
  	<div>
...
import simpleProduct from './components/simpleProductList.vue'
import spinner from './components/spinner.vue'
import price from './components/price.vue'
import { addToCart } from './vuex/actions'
import { productList } from './vuex/getters'
export default {
	components: { simpleProduct, spinner, price },
	store,
	vuex: {
		actions: {
			addToCart
